...
const EARLY = [
  ...
  "¿Cómo se juntaba tu familia cuando eras chico?",
  "¿Con quién pasabas más tiempo de niño?",
  "¿Tu familia tenía alguna tradición especial?",
  "¿Cómo era la casa donde creciste?",
  "¿Tenías mascotas de niño?",
  "¿Había algún familiar —tío, abuelo, primo— con quien fueras muy cercano?",
  "¿A qué colegio fuiste de niño?",
  "¿Cuál es tu recuerdo más feliz de la infancia?",
  "¿Qué momentos del colegio básico recuerdas más?",
  "¿Quiénes eran tus amigos de la infancia?",
  "¿Cuáles eran tus juegos o juguetes favoritos?",
  "¿Alguno de esos amigos de la infancia sigue en tu vida?",
  "¿Qué hacías para entretenerte cuando eras chico?",
  "¿Qué películas, música y libros te gustaban de niño?",
  "¿Te enfermaste gravemente o tuviste algún accidente serio de chico?",
  ...
  "¿Quiénes eran los famosos de tu época?",
...
const MID = [
  ...
  "¿Recuerdas adónde fueron en su primera salida?",
  ...
  "Cuéntame del día que nació tu primer hijo.",
  ...
  "¿Cuál es tu historia favorita de cuando tus hijos eran adolescentes?",
  "Cuéntame de un momento del que te hayas sentido muy orgulloso de cada uno.",
  "¿Cómo fue cuando tus hijos se fueron de la casa?",
  "¿Perdiste algún familiar cercano durante esa época?",
  "¿A qué te dedicaste en tu vida profesional?",
  "¿Cuáles son tus logros profesionales de los que más te enorgulleces?",
  "¿Quiénes eran tus mejores amigos en esa etapa?",
  "¿Cómo se juntaban?",
...
const LATE = [
  ...
  "¿Cómo ha cambiado tu relación con tus hijos en estos años?",
  ...
  "¿Quién es tu amigo más antiguo? ¿Cómo se conocieron?",
